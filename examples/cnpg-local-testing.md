...
```bash
docker build -f Dockerfile.cnpg -t ghcr.io/proventuslabs/pg_timers-cnpg:18-latest .
k3d image import ghcr.io/proventuslabs/pg_timers-cnpg:18-latest -c pg-timers-test
```
