-- pg_timers check_interval_ms and action_timeout_ms GUC tests
BEGIN;
SELECT plan(4);
...
-- action_timeout_ms defaults to 0 (no limit)
SELECT is(
    current_setting('pg_timers.action_timeout_ms')::integer,
    0,
    'action_timeout_ms defaults to 0 (no limit)'
);
